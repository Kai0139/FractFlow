...
class QwenImageTool(ToolTemplate):
    """Qwen image generation and editing tool using ToolTemplate"""
    
    SYSTEM_PROMPT = """
你是一个专业的AI图像生成和编辑助手，使用Qwen的图像能力帮助用户创建和修改图像。
...
"""
    ...
    TOOLS = [
        ("tools/core/qwen_image/qwen_image_mcp.py", "qwen_image")
    ]
    ...
    def create_config(cls):
        ...
        return ConfigManager(
            ...
            max_iterations=1,  # Image generation and editing
